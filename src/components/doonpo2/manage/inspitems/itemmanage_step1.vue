  ...
  data () {
   ...
   methods: {
    gettableItems(){
       ...
       axios.get(`${this.$D2ApiPath}/api/manage/item/list/step1`, { headers: { Authorization: token } }) 
        .then(response => {
    ...
    calldetail(wcen,maco,ln,pn) {
        this.$router.push({path: '/dp2/admin/manageitem/stp2', query:{line: wcen, part: maco, line_name: ln, part_name: pn} });
        },
  },
}
</script>
