  ...
  export default {
    ...
    methods:{
        fetchData(){
          ...
          try {
            ...
            if(this.$route.query.jgcd == "주"){
              axios.get(`${this.$D2ApiPath}/api/inspection/getLineTargetListWeek?date=` + this.$route.query.workdate, { headers: { Authorization: token } } )
              .then(response => {
                this.tableItems = response.data 
                this.loading=false;
              })
            }else{
              axios.get(`${this.$D2ApiPath}/api/inspection/getLineTargetList?date=` + this.$route.query.workdate, { headers: { Authorization: token } } )
              .then(response => {
                this.tableItems = response.data 
                this.loading=false;
              })
         ...
         getApproved(){
          const token = localStorage.getItem('token')
          axios.get(`${this.$D2ApiPath}/api/approval/doc?date=` + this.$route.query.workdate+'&jgcd='+ this.$route.query.jgcd, { headers: { Authorization: token } } )
          .then(response => {
        ...
        save(){
          ...
          const token = localStorage.getItem('token')
              axios.patch(`${this.$D2ApiPath}/api/approval/detail/doc`,arr, { headers: { Authorization: token } } )
              .then(response => {
