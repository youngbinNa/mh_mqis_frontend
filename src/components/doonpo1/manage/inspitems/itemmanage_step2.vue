  ...
  watch: {
   ...
   methods: {
    gettableItems(){
       ...
       axios.get(`${this.$D1ApiPath}/api/manage/item/list/` + this.$route.query.line +'/'+this.$route.query.part, { headers: { Authorization: token } }) 
        .then(response => {
    ...
    gettablePartItems(){
       const token = localStorage.getItem('token')
       axios.get(`${this.$D1ApiPath}/api/manage/item/part/list`, { headers: { Authorization: token } }) 
        .then(response => {
    ...
    deleteItemConfirm () {
      const token = localStorage.getItem('token')
      axios.patch(`${this.$D1ApiPath}/api/manage/item/list/DEL`,this.editedItem, { headers: { Authorization: token }} )
        .then(r => {
    ...
    save () {
      ...
      if (this.editedIndex > -1) { //수정
        ...
        axios.patch(`${this.$D1ApiPath}/api/manage/item/list/UPD`,this.editedItem, { headers: { Authorization: token }} )
          .then(r => {
            alert(r.data.output.outmsg) //(이)가 정상 처리 되었습니다.
          })
          this.close()
        ...
        axios.patch(`${this.$D1ApiPath}/api/manage/item/list/INS`,this.editedItem, { headers: { Authorization: token }} )
          .then(r => {
            alert(r.data.output.outmsg) //(이)가 정상 처리 되었습니다.
          })
        //this.submit();
    ...
    activate_USE_YN(item){
      const token = localStorage.getItem('token')
      axios.patch(`${this.$D1ApiPath}/api/manage/item/active`,item, { headers: { Authorization: token }} )
        .then(r => {
...
*/
      ...
      axios.post(`${this.$D1ApiPath}/api/manage/item/upload/`+this.editedItem.INDEX_KEY+'/'+this.editedItem.WCEN+'/'+this.editedItem.MACO , formData, {  
          headers: {
                    Authorization: token,
    ...
    getTableImageInPath(item){
      return item.IMAGE ? `${this.$D1ApiPath}/images/`+item.IMAGE : `${this.$D1ApiPath}/images/patrolsample.png`
    },
  ...
  computed: {
    ...
    getImagePath (){
      return this.editedItem.IMAGE ? `${this.$D1ApiPath}/images/`+this.editedItem.IMAGE : `${this.$D1ApiPath}/images/patrolsample.png`
    },
  },
}
</script>
