  ...
  data () {
   ...
   methods: {
    gettableItems(){
       ...
       axios.get(`${this.$D1ApiPath}/api/manage/item/list/step1`, { headers: { Authorization: token } }) 
        .then(response => {
    ...
    calldetail(wcen,maco,ln,pn) {
        this.$router.push({path: '/dp1/admin/manageitem/stp2', query:{line: wcen, part: maco, line_name: ln, part_name: pn} });
        },
  },
}
</script>
