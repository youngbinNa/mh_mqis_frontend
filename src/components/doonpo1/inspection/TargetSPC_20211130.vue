                  ...
                  <v-row class="pa-0 ma-0">
                    <v-col class="pa-0 ma-0">
                      <v-row class="pa-0 ma-0">
                        <v-col  style="text-align:right" >
                          <template v-if="item.IS_DONE!=1">
                            <v-btn  tile @click="callDetailView(item.WCEN,item.MACO,item.INDEX_KEY)">
                                <v-icon left>mdi-lead-pencil</v-icon>검사시작
                            </v-btn>
                          </template>
                          <template v-else>
                              <v-btn  tile outlined color="success" @click="callDetailView(item.WCEN,item.MACO,item.INDEX_KEY)">
                                  <v-icon left>mdi-lead-pencil</v-icon>수정
                              </v-btn>
                          </template>
                        </v-col>
