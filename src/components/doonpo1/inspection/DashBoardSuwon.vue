  ...
  export default {
    ...
    methods:{
        retrieveCalendar(){
         ...
         axios.get(`${this.$D1ApiPath}/api/dashboard/get1?date=` + this.date.replace(/-/g, "")+'&zone='+ this.filter, { headers: { Authorization: token } } )
            .then(response => {
        ...
        retrieveCalendarWeek(){
          ...
          axios.get(`${this.$D1ApiPath}/api/dashboard/get2?date=` + firstday.replace(/-/g, "")+'&zone='+ this.filterweek, { headers: { Authorization: token } } )
            .then(response => {
