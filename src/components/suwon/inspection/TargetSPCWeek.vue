...
import DoModal from './detail/PatrolDoWeek_Modal';
  ...
  export default {
    ...
    methods: {
      ...
      openModal (qLINE,qPART,qCPID) {
        ...
        axios.patch(`${this.$SuwonApiPath}/api/inspection/todo/starttime/week/`+ qCPID,this.$store.state.user , { headers: { Authorization: token } })
      ...
      Initialize(){
        ...
        //       })
        axios.get(`${this.$SuwonApiPath}/api/inspection/target/spclist/week/` + this.$route.query.line +'/'+this.$route.query.part+'/'+this.$route.query.workdate.replace(/-/g, "")+'/'+this.$route.query.zone, { headers: { Authorization: token } }) 
            .then(response => {
