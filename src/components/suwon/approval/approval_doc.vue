        ...
        fetchData(){
          ...
          try {
            ...
            if(this.$route.query.jgcd == "주"){
              axios.get(`${this.$SuwonApiPath}/api/inspection/getLineTargetListWeek?date=` + this.$route.query.workdate, { headers: { Authorization: token } } )
              .then(response => {
                this.tableItems = response.data 
                this.loading=false;
              })
            }else{
              axios.get(`${this.$SuwonApiPath}/api/inspection/getLineTargetList?date=` + this.$route.query.workdate, { headers: { Authorization: token } } )
              .then(response => {
                this.tableItems = response.data 
                this.loading=false;
              })
         ...
         getApproved(){
          const token = localStorage.getItem('token')
          axios.get(`${this.$SuwonApiPath}/api/approval/doc?date=` + this.$route.query.workdate+'&jgcd='+ this.$route.query.jgcd, { headers: { Authorization: token } } )
          .then(response => {
