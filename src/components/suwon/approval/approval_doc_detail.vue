...
//import SimpleKeyboard from './keyboard/NumericKeyboard';
  ...
  export default {
    ...
    created(){
      ...
      //  axios.get(`${this.$SuwonApiPath}/api/inspection/target/percent/week/` + this.$route.query.line +'/'+this.$route.query.part+'/'+this.$route.query.workdate.replace(/-/g, "")+'/'+this.$route.query.zone, { headers: { Authorization: token } }) 
      //       .then(response => {
      //         this.percentItem = response.data.recordset
      ...
      //       })
        axios.get(`${this.$SuwonApiPath}/api/inspection/target/spclist/week/` + this.$route.query.line +'/'+this.$route.query.part+'/'+this.$route.query.workdate.replace(/-/g, "")+'/'+this.$route.query.zone, { headers: { Authorization: token } }) 
            .then(response => {
              this.tableItems = response.data.recordset
